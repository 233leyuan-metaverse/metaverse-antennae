...
For component writes, follow [user-component-workflow.md](user-component-workflow.md) and require hot reload plus exact persisted readback. Use `code.read_component` only for diagnosis or uncertain-result reconciliation.
